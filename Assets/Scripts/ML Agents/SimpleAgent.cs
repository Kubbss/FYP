...
public class SimpleAgent : Agent
{
    ...
    {
        var rotateActions = actionsOut.DiscreteActions;
    ...
    {
        var rotateAction = actionSegment[0];
        var moveAction = actionSegment[1];
    ...
    private void ResetArea()
    {
        ...
        playerTarget.localPosition = new Vector3(Random.Range(-4.5f, 4.5f), 0.3f, Random.Range(-4.5f, 4.5f));
